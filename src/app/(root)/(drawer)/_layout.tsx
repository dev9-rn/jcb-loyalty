  ...
  return (
    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          drawerLabel: t("login.dashboard_title"),
          title: t("login.dashboard_title"),
            ...
            <>
              {userDetails?.userType != 2 ? (
                <Button
                  ...
                  size={"icon"}
                  onPress={() =>
                    router.navigate("/(root)/(stack)/notification")
                  }
                >
                  {notificationCount > 0 && (
      ...
      <Drawer.Screen
        name="camera"
        options={{
          drawerLabel: t("login.sdemenu_scan"),
          drawerIcon: ({ focused, color }) => (
      ...
      <Drawer.Screen
        ...
        options={{
          drawerLabel: t("login.sidemenu_couponhistory"),
          title: t("login.sidemenu_couponhistory"),
          drawerIcon: ({ focused, color }) => (
      ...
      <Drawer.Screen
        ...
        options={{
          drawerLabel: t("login.cashbash"),
          title: t("login.cashbash"),
          drawerIcon: ({ focused, color }) => (
      ...
      <Drawer.Screen
        ...
        options={{
          drawerLabel: t("login.sidemenu_report"),
          title: t("login.sidemenu_report"),
          drawerIcon: ({ focused, color }) => (
      ...
      <Drawer.Screen
        ...
        options={{
          drawerLabel: t("login.sidemenu_reporthistory"),
          title: t("login.sidemenu_reporthistory"),
          drawerIcon: ({ focused, color }) => (
