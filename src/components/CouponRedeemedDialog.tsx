      ...
      <DialogContent className="max-w-sm">
          ...
          <View className="items-center gap-2">
            <DialogTitle className="!text-primary">
              {redeemedData?.redeemMethods && (
                <>
                  {redeemedData?.redeemMethods[0].redeem_type === "1"
                    ? "FOC Coupon"
                    : "Cash Coupon"}
                </>
              )}
              {redeemedData?.redeemedMethods && (
                <>
                  {redeemedData?.redeemedMethods[0].redeem_type === "1"
                    ? "FOC Coupon"
                    : "Cash Coupon"}
                </>
              )}
            ...
            <View className="flex-row items-center gap-2">
              ...
              <View className="">
                <Text className="text-primary font-medium">
                  {redeemedData?.couponData.product_name}
                </Text>
                <Text className="text-primary font-medium">
                  {redeemedData?.couponData.value}
                </Text>
              </View>
            </View>
          </View>
        ...
        <DialogFooter>
          <DialogClose asChild>
            <Button
              onPress={() => {
                (setActive(true), setIsCouponRedeem(false));
              }}
            >
              <Text>OK</Text>
            </Button>
