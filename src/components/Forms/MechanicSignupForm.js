...
import { Dimensions, Alert, Platform, StyleSheet, View, TextInput, ScrollView, TouchableOpacity } from 'react-native';
import { Header, Left, Body, Content, Toast, Card, Form, Label, Text, Title, Icon, Item, Input, CardItem } from 'native-base';
...
export default class MechanicSignupForm extends Component {
    ...
    _onPressButton = () => {
        // console.log(this.state, "1234567");
