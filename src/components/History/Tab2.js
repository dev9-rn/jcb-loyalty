...
class Tab2 extends Component {
	...
	handleDatePicked = date => {
		// this.setState({ offset: 0, redeemHistorySchemeArr: [] })
		// let a = date;
		...
		// if (a > b) {
			...
			this.setState({ fromDateError: 'FromDate cannot be greater than toDate.',open1:false, noMoreDataError: '', })
		} else {
			this.forceUpdate();
			// this.setState({ fromDateError: '', toDateError: '' })
			// this.setState({ frmDate: a.format("DD-MM-yyyy"), open1: false, })
			// this.callApi();
