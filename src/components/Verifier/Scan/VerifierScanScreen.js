...
import {  Alert, StatusBar,  BackHandler, Dimensions, Platform, StyleSheet, View, Image, TouchableOpacity, Linking } from 'react-native';
...
export default class VerifierScanScreen extends React.Component{
	...
	componentWillMount() {
		this.setState({isConnected: ISNETCONNECTED});
		this._getAsyncData();
	}
	...
	handleConnectivityChange = isConnected => {
  	...
  	_showNetErrMsg(){
  		if (!this.state.isConnected || !ISNETCONNECTED) {
			Alert.alert(
